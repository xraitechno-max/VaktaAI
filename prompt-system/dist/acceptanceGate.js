 ...
 */
import { extractCitations, findUncitedSentences } from "./utils/citations.js";
...
export class AcceptanceGate {
     ...
     */
    verify(draft, targetLanguage, mode, attemptNumber = 0) {
        ...
        const regeneration_strategy = should_regenerate
            ...
            : { attempt_number: 0, action: "none", switch_model: false };
        const report = {
            overall_pass,
            confidence_score,
            should_regenerate,
     ...
     */
    runLanguageCheck(draft, targetLanguage) {
        const text = draft.raw_text;
     ...
     */
    calculateConfidence(factCheck, mathCheck, languageCheck) {
        ...
        const weightedScore = (factCheck.score * weights.fact + mathCheck.score * weights.math + languageCheck.score * weights.language) /
            totalWeight;
     ...
     */
    getRegenerationStrategy(attemptNumber, factCheck, mathCheck, languageCheck) {
     ...
     */
    getTightenedInstructions(factCheck, mathCheck, languageCheck, strict = false) {
        const issues = [];
        if (!factCheck.passed) {
...
//# sourceMappingURL=acceptanceGate.js.map
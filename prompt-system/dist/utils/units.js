 ...
 */
export function isValidSIUnit(unit) {
 ...
 */
export function extractFormulasWithUnits(text) {
 ...
 */
export function verifyUnitConsistency(calculation) {
    const errors = [];
 ...
 */
export function checkFormulasInEnglish(text) {
 ...
 */
export function verifySigFigs(calculation) {
    // Extract all numbers

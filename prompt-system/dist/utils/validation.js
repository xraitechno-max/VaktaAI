 ...
 */
export function detectCOTLeakage(text) {
 ...
 */
export function validateFormulasInEnglish(formulas) {
    const violations = [];
 ...
 */
export function extractFactualClaims(text) {
    ...
    for (const sentence of sentences) {
        ...
        if (sentence.toLowerCase().includes("samajh me aaya") ||
 ...
 */
export function calculateQualityScore(text, metadata) {

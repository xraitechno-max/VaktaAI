 ...
 */
export function recordResponse(mode, subject, lang, model, confidence, regenerations, latencyMs) {
 ...
 */
export function recordLanguageDetection(detected, switched, confidence) {
 ...
 */
export function recordCitationValidation(mode, subject, passed, reason) {
    if (passed) {
 ...
 */
export function recordRAGRetrieval(mode, subject, chunkCount, avgSimilarity) {
 ...
 * Record model call
 */
export function recordModelCall(model, attempt, latencyMs, promptTokens, completionTokens) {

...
export class PromptBuilder {
     ...
     */
    assembleSystemPrompt(template, task, language) {
        let prompt = template;
     ...
     */
    processConditional(template, condition, include) {
     ...
     * Assemble user prompt with evidence
     */
    assembleUserPrompt(userMsg, evidence, mode) {

...
export class Router {
        ...
        this.rules = [
            {
                name: "numeric_heavy",
                conditions: (task) => {
                    return ((task.signals?.numeric === true || task.mode === "solve" || task.mode === "derive") &&
            ...
            },
            {
                ...
                conditions: (task) => {
                    return ((task.mode === "explain" || task.mode === "revise" || task.mode === "strategy") &&
     ...
     */
    getNextFallback(decision, attemptNumber) {

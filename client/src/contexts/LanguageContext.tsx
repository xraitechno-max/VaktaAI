...
const translations: Translations = {
  ...
  'subject.science': { en: 'Science', hi: 'विज्ञान' },
  'subject.social': { en: 'Social Science', hi: 'सामाजिक विज्ञान' },
  'subject.english': { en: 'English', hi: 'अंग्रेज़ी' },
  'subject.hindi': { en: 'Hindi', hi: 'हिंदी' },
  'subject.computer': { en: 'Computer Science', hi: 'कंप्यूटर साइंस' },
  'subject.physicalEducation': { en: 'Physical Education', hi: 'शारीरिक शिक्षा' },
  'subject.economics': { en: 'Economics', hi: 'अर्थशास्त्र' },
  'subject.accountancy': { en: 'Accountancy', hi: 'लेखाशास्त्र' },
  'subject.businessStudies': { en: 'Business Studies', hi: 'व्यवसाय अध्ययन' },
  'subject.fineArts': { en: 'Fine Arts', hi: 'ललित कला' },
  'subject.music': { en: 'Music', hi: 'संगीत' },
  
  // Topic translations for new subjects
  'topic.science.physics': { en: 'Physics', hi: 'भौतिकी' },
  'topic.science.chemistry': { en: 'Chemistry', hi: 'रसायन' },
  'topic.science.biology': { en: 'Biology', hi: 'जीव विज्ञान' },
  'topic.social.history': { en: 'History', hi: 'इतिहास' },
  'topic.social.geography': { en: 'Geography', hi: 'भूगोल' },
  'topic.social.civics': { en: 'Civics', hi: 'नागरिक शास्त्र' },
  'topic.english.grammar': { en: 'Grammar', hi: 'व्याकरण' },
  'topic.english.literature': { en: 'Literature', hi: 'साहित्य' },
  'topic.english.writing': { en: 'Writing', hi: 'लेखन' },
  'topic.hindi.vyakaran': { en: 'Vyakaran', hi: 'व्याकरण' },
  'topic.hindi.sahitya': { en: 'Sahitya', hi: 'साहित्य' },
  'topic.hindi.lekhan': { en: 'Lekhan', hi: 'लेखन' },
  'topic.computer.programming': { en: 'Programming', hi: 'प्रोग्रामिंग' },
  'topic.computer.dataStructures': { en: 'Data Structures', hi: 'डेटा स्ट्रक्चर्स' },
  'topic.computer.algorithms': { en: 'Algorithms', hi: 'एल्गोरिदम' },
  'topic.pe.sports': { en: 'Sports', hi: 'खेल' },
  'topic.pe.fitness': { en: 'Fitness', hi: 'फिटनेस' },
  'topic.pe.health': { en: 'Health', hi: 'स्वास्थ्य' },
  'topic.economics.micro': { en: 'Microeconomics', hi: 'सूक्ष्म अर्थशास्त्र' },
  'topic.economics.macro': { en: 'Macroeconomics', hi: 'समष्टि अर्थशास्त्र' },
  'topic.economics.indian': { en: 'Indian Economy', hi: 'भारतीय अर्थव्यवस्था' },
  'topic.accountancy.financial': { en: 'Financial Accounting', hi: 'वित्तीय लेखांकन' },
  'topic.accountancy.company': { en: 'Company Accounts', hi: 'कंपनी खाते' },
  'topic.accountancy.analysis': { en: 'Financial Analysis', hi: 'वित्तीय विश्लेषण' },
  'topic.business.management': { en: 'Management', hi: 'प्रबंधन' },
  'topic.business.marketing': { en: 'Marketing', hi: 'मार्केटिंग' },
  'topic.business.finance': { en: 'Finance', hi: 'वित्त' },
  'topic.arts.painting': { en: 'Painting', hi: 'चित्रकला' },
  'topic.arts.sculpture': { en: 'Sculpture', hi: 'मूर्तिकला' },
  'topic.arts.drawing': { en: 'Drawing', hi: 'रेखाचित्र' },
  'topic.music.vocal': { en: 'Vocal', hi: 'गायन' },
  'topic.music.instrumental': { en: 'Instrumental', hi: 'वाद्य' },
  'topic.music.theory': { en: 'Music Theory', hi: 'संगीत सिद्धांत' },
  ...
  'aiMentor.selectChapter': { en: 'Select Chapter', hi: 'अध्याय चुनें' },
  'aiMentor.noChaptersAvailable': { en: 'No chapters available for this subject', hi: 'इस विषय के लिए कोई अध्याय उपलब्ध नहीं' },
  'aiMentor.skipChapterSelection': { en: 'Skip - Ask Any Question', hi: 'छोड़ें - कोई भी सवाल पूछें' },
  'aiMentor.skipChapterHint': { en: 'AI will help with any topic in this subject', hi: 'AI इस विषय के किसी भी टॉपिक में मदद करेगा' },

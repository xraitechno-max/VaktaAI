  ...
  return (
    <div className="h-full flex flex-col bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 relative overflow-hidden">
      ...
      <div className={`relative flex-1 min-h-0 overflow-hidden ${showChatPanel ? 'grid grid-cols-1 md:grid-cols-[60%_40%]' : 'flex flex-col'
        ...
        {showChatPanel && (
          <div className="flex flex-col bg-slate-900/50 backdrop-blur-xl border-t md:border-t-0 md:border-l border-white/5 min-h-[200px] max-h-[40vh] md:max-h-none overflow-hidden">
